    ...
    return (
        <div className="bg-white dark:bg-black container w-full min-h-screen flex flex-col items-center px-4 md:px-12 lg:px-20">
            ...
            <div className="mt-8 text-center max-w-4xl">
                <p className="text-xl text-black dark:text-white leading-relaxed font-semibold font-poppins">
                ...
                <p className="text-xl text-black dark:text-white leading-relaxed mt-4 font-semibold font-poppins">
            ...
            <div className="mt-8 text-center max-w-4xl">
                <p className="text-xl text-black dark:text-white leading-relaxed font-poppins">
                ...
                <p className="text-xl text-black dark:text-white leading-relaxed mt-4 font-poppins">
